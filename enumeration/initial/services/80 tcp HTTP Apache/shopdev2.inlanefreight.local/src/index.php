...
<div id="main_container">
  ...
  <div id="main_content">
    <div id="menu_tab">
      <ul class="menu">
        ...
        <li><a href="cart.php" class="nav">My Cart</a></li>
    ...
    <div class="center_content">
      ...
      <div class="prod_box">
        <div class="center_prod_box">
          <div class="product_title"><a href="#">Battle Axe</a></div>
          <div class="product_img"><a href="#"><img src="images/p7.jpg" alt="" border="0" /></a></div>
          <div class="prod_price"><span class="reduce">270$</span> <span class="price">120$</span></div>
        </div>
        <div class="prod_details_tab"> <a href="#" class="prod_buy">Add to Cart</a> <a href="#" class="prod_details">Details</a> </div>
      </div>
      <div class="prod_box">
  ...
  <div class="footer">
    ...
    <div class="center_footer"> Template name. All Rights Reserved 2008<br />
      <a href="#"><img src="images/csscreme.jpg" alt="csscreme" title="csscreme" border="0" /></a><br />
